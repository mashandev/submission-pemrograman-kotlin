...
// Ini adalah jawaban alternatif jika membutuhkan pengecekan tipe data yang hanya menggunakan one line code
// fun <T> checkType(args: T): String = "Yes! it's ${args!!::class.simpleName}"
